...
let product = {
    plainBurger: {
        ...
        amount: 0,
        img: 'images/001.jpg',
        descr: 'Прекрасные, нежные и воздушные — эти французские заварные пирожные завоевали весь мир',
        get Summ() {
    ...
    freshBurger: {
        ...
        amount: 0,
        img: 'images/002.jpg',
        descr: 'Вкусные булочки тающие во рту',
        get Summ() {
            return this.price * this.amount;
        },
        get Kcall() {
    ...
    freshCombo: {
        ...
        amount: 0,
        img: 'images/003.jpg',
        descr: 'Этот вкуснейший десерт пришел к нам из Англии.',
        get Summ() {
            return this.price * this.amount;
        },
        get Kcall() {
